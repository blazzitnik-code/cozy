// ─── CLASSNAMES ───
// Tiny conditional-class joiner: cx('base', active && 'text-sky-400').
...
export const STATUS_CARD = { expired: "bg-red-500/8 border-red-500/20", warning: "bg-amber-500/8 border-amber-500/15", ok: "bg-green-500/4 border-indigo-500/15 dark:border-slate-600/20" };
export const STATUS_BADGE = { expired: "text-red-500 bg-red-500/8", warning: "text-amber-500 bg-amber-500/8", ok: "text-green-500 bg-green-500/8" };
...
export const DUE_BADGE = { past: "bg-red-500/13 text-red-500", urgent: "bg-amber-500/13 text-amber-500", normal: "bg-purple-500/13 text-purple-500" };
