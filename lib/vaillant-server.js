...
export function toFriendlyError(err) {
  ...
  if (message === 'BLOCKED_BY_WAF') {
    return new VaillantFriendlyError(
      'blocked_by_waf',
      'Vaillant je zahtevo blokiral kot sumljiv promet (zaščita pred boti). Poskusi znova čez nekaj minut.',
    );
  }
